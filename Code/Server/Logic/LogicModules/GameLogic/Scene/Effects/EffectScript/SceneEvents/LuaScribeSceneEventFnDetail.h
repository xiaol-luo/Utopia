...
namespace GameLogic
{
	...
	/// sol_ignore
	class LuaScribeSceneEventFnDetail_OnSceneUnitVolecityChange : public LuaScribeSceneEventFnDetail { LuaScribeSceneEventFnDetail_ClassBody; };
	/// sol_ignore
	class LuaScribeSceneEventFnDetail_OnSceneUnitMoveStateChange : public LuaScribeSceneEventFnDetail { LuaScribeSceneEventFnDetail_ClassBody; };
	/// sol_ignore
	...
	/// sol_ignore
	class LuaScribeSceneEventFnDetail_OnSceneUnitPosChange : public LuaScribeSceneEventFnDetail { LuaScribeSceneEventFnDetail_ClassBody; };
	/// sol_ignore
	...
	/// sol_ignore
	class LuaScribeSceneEventFnDetail_OnSceneUnitEnterLeaveScene : public LuaScribeSceneEventFnDetail
	{
		LuaScribeSceneEventFnDetail_ClassBody;
		LuaScribeSceneEventFnDetail_OnSceneUnitEnterLeaveScene(int _event_id, std::string _lua_fn_name) { event_id = _event_id; lua_fn_name = _lua_fn_name; }
		int event_id;
		std::string lua_fn_name;
	};
}