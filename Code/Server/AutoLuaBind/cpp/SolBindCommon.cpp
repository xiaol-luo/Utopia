...
namespace SolLuaBind 
{
        ...
        extern void LuaBind_GameLogic_LuaSubscribeSceneEventDetail(lua_State *L);
        extern void LuaBind_GameLogic_SceneUnit(lua_State *L);
        extern void LuaBind_GameLogic_LuaScribeSceneEventFnDetail(lua_State *L);
        extern void LuaBind_GameLogic_LuaScribeSceneEventFnDetail_OnSceneUnitFightParamChange(lua_State *L);
	...
	void SolLuaBind(lua_State *L)
	{
            ...
            LuaBind_GameLogic_LuaSubscribeSceneEventDetail(L);
            LuaBind_GameLogic_SceneUnit(L);
            LuaBind_GameLogic_LuaScribeSceneEventFnDetail(L);
            LuaBind_GameLogic_LuaScribeSceneEventFnDetail_OnSceneUnitFightParamChange(L);
