...
{
	void LuaBind_GameLogic_SceneUnitFilterWayParams__exclude_suids(lua_State *L)
	{
		struct LuaBindImpl
		{
			...
			static void DoLuaBind(lua_State *L)
			{
				...
				{
					sol::usertype<GameLogic::SceneUnitFilterWayParams::_exclude_suids> meta_table(
						"__StructName__", sol::property([]() {return "_exclude_suids"; })				
						,"excludeSuids", &GameLogic::SceneUnitFilterWayParams::_exclude_suids::excludeSuids
					);
