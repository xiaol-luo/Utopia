...
{
    public class HurtEffectEditor : EffectEditorBase
    {
        public HurtEffectEditor(EffectTabData _tabData) : base(_tabData)
        {
        }
        ...
        public override void ImplEditorLogic()
        {
            ...
            using (new EditorGUILayout.VerticalScope())
            {
                ...
                currCfg.value = EditorGUILayout.IntField("value", currCfg.value);
            }
        }
