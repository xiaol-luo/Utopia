...
_VIEWSNAPSHOT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='grids', full_name='NetProto.ViewSnapshot.grids', index=0,
...
_VIEWSNAPSHOT.fields_by_name['grids'].message_type = _VIEWGRID
