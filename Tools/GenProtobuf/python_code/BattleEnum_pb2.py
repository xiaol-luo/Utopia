...
_ESKILLEFFECTCASE = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='ESkillEffectCase_None', index=0, number=0,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ESkillEffectCase_Self', index=1, number=1,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ESkillEffectCase_Friend', index=2, number=2,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ESkillEffectCase_Enemy', index=3, number=3,
      options=None,
      type=None),
  ],
  containing_type=None,
