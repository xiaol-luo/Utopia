...
_ESKILLSTATE = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='ESS_Preparing', index=0, number=0,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ESS_Releasing', index=1, number=1,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ESS_Using', index=2, number=2,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ESS_Lasting', index=3, number=3,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ESS_End', index=4, number=4,
      options=None,
      type=None),
  ],
  containing_type=None,
