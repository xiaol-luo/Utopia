...
_ESKILLUSEWAY = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ESkillTarget_Postion', index=2, number=2,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_ESKILLTARGETCASE = _descriptor.EnumDescriptor(
  name='ESkillTargetCase',
  full_name='NetProto.ESkillTargetCase',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_ESKILLTARGETCASE)

ESkillTargetCase = enum_type_wrapper.EnumTypeWrapper(_ESKILLTARGETCASE)
Building = 0
Hero = 1
Npc = 2
MAX = 3
...
DESCRIPTOR.enum_types_by_name['ESkillTargetCase'] = _ESKILLTARGETCASE
