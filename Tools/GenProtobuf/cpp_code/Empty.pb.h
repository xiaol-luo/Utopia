...
#ifndef PROTOBUF_Empty_2eproto_INCLUDED
#define PROTOBUF_Empty_2eproto_INCLUDED
...
namespace google {
namespace protobuf {
template<> ::NetProto::Empty* Arena::CreateMessage< ::NetProto::Empty>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace NetProto {
...
class Empty : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:NetProto.Empty) */ {
 ...
 private:
  ...
  friend void ::protobuf_Empty_2eproto::InitDefaultsEmptyImpl();
};
// ===================================================================
...
#endif  // PROTOBUF_Empty_2eproto_INCLUDED
