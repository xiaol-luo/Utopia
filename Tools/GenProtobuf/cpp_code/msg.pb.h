...
#ifndef PROTOBUF_msg_2eproto_INCLUDED
#define PROTOBUF_msg_2eproto_INCLUDED
...
namespace google {
namespace protobuf {
template<> ::NetProto::Ping* Arena::CreateMessage< ::NetProto::Ping>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace NetProto {
...
class Ping : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:NetProto.Ping) */ {
 public:
  ...
  inline Ping* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::CreateMessage<Ping>(NULL);
  }
 ...
 private:
  ...
  friend void ::protobuf_msg_2eproto::InitDefaultsPingImpl();
};
// ===================================================================
...
#endif  // PROTOBUF_msg_2eproto_INCLUDED
